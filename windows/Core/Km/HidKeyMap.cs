...
public static class HidKeyMap
{
    ...
    private static readonly Dictionary<ushort, ushort> ScanToHid = new()
    {
        ...
        { 0x47, 0x4A }, { 0x49, 0x4B }, { 0x4F, 0x4D }, { 0x51, 0x4E }, { 0x53, 0x4C },
        { 0x4D, 0x4F }, { 0x4B, 0x50 }, { 0x50, 0x51 }, { 0x48, 0x52 },
        // Modifiers
        { 0x1D, 0xE0 }, // LCtrl
        { 0x2A, 0xE1 }, // LShift
        { 0x38, 0xE2 }, // LAlt
        { 0x36, 0xE5 }, // RShift (in scancode set 1)
        // Note: RCtrl (E0 1D) and RAlt (E0 38) come through with the extended-key flag and the
        // base scan code; the LowLevelHooks layer should normalize before lookup.
    };
